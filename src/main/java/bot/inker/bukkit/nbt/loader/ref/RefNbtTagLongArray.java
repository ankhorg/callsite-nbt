...
public final class RefNbtTagLongArray extends RefNbtList<RefNbtTagLong> {
  @HandleBy(version = CbVersion.v1_16_R3, reference = "Lnet/minecraft/server/v1_16_R3/NBTTagLongArray;<init>([J)V")
  public RefNbtTagLongArray(long[] value) {
    throw new UnsupportedOperationException();
  }

  @HandleBy(version = CbVersion.v1_16_R3, reference = "Lnet/minecraft/server/v1_16_R3/NBTTagLongArray;<init>(Ljava/util/List;)V")
